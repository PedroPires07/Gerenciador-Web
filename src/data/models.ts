...
export interface Termo { id: string; cientifico: string; populares: string[]; descricao?: string; area: 'Medicina' | 'Odontologia'; categoria: string; status: 'Verificado' | 'Pendente'; atualizadoEm: string }
